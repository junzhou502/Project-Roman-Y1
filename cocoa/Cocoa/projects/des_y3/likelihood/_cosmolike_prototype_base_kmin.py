...
class _cosmolike_prototype_base(DataSetLikelihood):
  ...
  def initialize(self, probe):
    ...
    # kmin-effect test variant: NO extrap_kmin anywhere; lower bound -4.85
    # (10^-4.85 = 1.4125e-05/Mpc) sits above the worst-case CAMB transfer-grid
    # kmin = 1.3922e-05/Mpc verified at the prior corner H0=91, omegam=0.9
    # (tau0 = 6841 Mpc), so no extrapolation is ever needed in the prior volume
    self.log10k_interp_2D = np.linspace(-4.85,2.0,int(1250+250*self.accuracyboost))
